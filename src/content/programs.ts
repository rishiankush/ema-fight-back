...
export const programs: Program[] = [
  {
    ...
    audience: "Ages 3–8",
    summary:
      "Play-based People Safety for young children: awareness, stranger safety, boundaries, and asking for help — without fear-based teaching.",
    format: "Small groups, parent-aware sessions, weekend workshops, or school modules.",
    duration: "45–60 minutes per session · workshop or short series",
    who: "Parents, preschool and primary classes, family groups.",
    learn: [
      "Recognising safe and unsafe situations in simple language",
      "Stranger safety and “who can help me”",
      "Personal boundaries and saying no",
      "Getting an adult’s attention quickly",
      "Buddy thinking and classroom safety habits",
    ],
    outcomes: [
      "Children feel capable, not frightened",
      "Parents get a shared safety vocabulary at home",
      "Teachers can reinforce the same messages in school",
    ],
  },
  {
    slug: "juniors",
    ...
    audience: "Ages 9–12",
    summary:
      "Bullying prevention, emotional safety, and practical skills for the years when peer pressure and independence both rise.",
    format: "Weekly classes, school modules, or holiday workshops.",
    duration: "60–75 minutes · 4–8 session series recommended",
    who: "Parents of juniors, middle-school coordinators, sports academies.",
    learn: [
      "What bullying is (a pattern, not a one-off fight)",
      "Verbal responses and getting help without shame",
      "Body language and personal space",
      "Simple Fullpower escape skills",
      "Digital and playground awareness",
    ],
    outcomes: [
      "Juniors can name the problem and report it clearly",
      "Confidence grows without aggression",
      "Schools get a consistent anti-bullying language",
    ],
  },
  {
    slug: "teens",
    ...
    audience: "Ages 13–18",
    summary:
      "Teenpower: emotional safety, harassment, travel, digital boundaries, and practical self-defense for real teenage life.",
    format: "School batches, weekend workshops, or small private groups.",
    duration: "90 minutes · one-day workshop or multi-session series",
    who: "Teenagers, parents, schools and junior colleges.",
    learn: [
      "Awareness in public spaces, transport, and parties",
      "Verbal boundary setting and harassment responses",
      "Emotional safety and peer pressure",
      "Practical Fullpower skills and escape",
      "How to help a friend and how to get adult support",
    ],
    outcomes: [
      "Teens leave with a plan, not just techniques",
      "Families talk about safety without panic",
      "Schools can run this as a structured life-skills module",
    ],
  },
  {
    slug: "adults",
